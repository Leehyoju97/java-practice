...
public class PrintWriterExample {
	public static void main(String[] args) {
		File printWriter1 = new File("src/basic19/fileex/printWriter1.txt");
		File printWriter2 = new File("src/basic19/fileex/printWriter2.txt");
		File printWriter3 = new File("src/basic19/fileex/printWriter3.txt");
